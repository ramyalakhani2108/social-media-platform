              ...
              <div>
                <Button className="w-full flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                  <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <path d="M18.14.953A5.965 5.965 0 0012 0C6.03 0 0 6.035 0 12c0 5.225 3.35 9.67 8.025 11.18.593.111.793-.26 0-1.797A4.925 4.925 0 004 15c3.046 0 5.268-2.674 5.268-5.655V6.237h.028v1.571h.223l-.355 2.326H9v-2.093c0-.248.195-.54.443-.54.284 0 .433.24.433.485v2.284H12c-1.874 0-2.745 1.492-2.745 2.769 0 1.584 1.084 2.953 2.745 2.953.873 0 1.643-.344 2.066-.878v-.082h-.22V15h-.03c-.215-.495-.85-.878-1.683-.878-1.31 0-2.394 1.08-2.394 2.473 0 1.403 1.16 2.537 2.7 2.537.956 0 1.795-.35 2.326-.902v-.053c.54.33.902.98.902 1.485 0 1.095-.012 2.323-.012 3.35 0 .477.31 1.057.76 1.057.41 0 .74-.27.74-.739 0-.536-.314-1.05-.732-1.05z" />
                  </svg>
